...
const file_proto_geoip_proto_rawDesc = "" +
	"\n" +
	"\x11proto/geoip.proto\x12\x15v2ray.core.app.router\".\n" +
	"\x04CIDR\x12\x0e\n" +
	"\x02ip\x18\x01 \x01(\fR\x02ip\x12\x16\n" +
	"\x06prefix\x18\x02 \x01(\rR\x06prefix\"[\n" +
	"\x05GeoIP\x12!\n" +
	"\fcountry_code\x18\x01 \x01(\tR\vcountryCode\x12/\n" +
	"\x04cidr\x18\x02 \x03(\v2\x1b.v2ray.core.app.router.CIDRR\x04cidr\"?\n" +
	"\tGeoIPList\x122\n" +
	"\x05entry\x18\x01 \x03(\v2\x1c.v2ray.core.app.router.GeoIPR\x05entryB(Z&github.com/CoderQuinn/ForgeRules/protob\x06proto3"
...
var file_proto_geoip_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_geoip_proto_goTypes = []any{
	(*CIDR)(nil),      // 0: v2ray.core.app.router.CIDR
	(*GeoIP)(nil),     // 1: v2ray.core.app.router.GeoIP
	(*GeoIPList)(nil), // 2: v2ray.core.app.router.GeoIPList
}
var file_proto_geoip_proto_depIdxs = []int32{
	0, // 0: v2ray.core.app.router.GeoIP.cidr:type_name -> v2ray.core.app.router.CIDR
	1, // 1: v2ray.core.app.router.GeoIPList.entry:type_name -> v2ray.core.app.router.GeoIP
